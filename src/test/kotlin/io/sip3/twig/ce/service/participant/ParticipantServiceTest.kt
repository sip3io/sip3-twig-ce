...
class ParticipantServiceTest {
    ...
    companion object {
        ...
        val EVENT_1 = Event(System.currentTimeMillis(), HOST_1.name, "10.20.30.40", "SIP", Document().apply {
            put("type", "SIP")
            put("src", HOST_1.name)
            put("dst", "10.20.30.40")
        ...
        val EVENT_2 = Event(System.currentTimeMillis(), "10.20.30.40", HOST_1.name, "SIP", Document().apply {
            put("type", "SIP")
            put("src", "10.20.30.40")
            put("dst", HOST_1.name)
        ...
        val EVENT_3 = Event(System.currentTimeMillis(), "20.20.30.40", HOST_2.name, "SIP", Document().apply {
            put("type", "SIP")
            put("src", "20.20.30.40")
            put("dst", HOST_2.name)
        ...
        val EVENT_4 = Event(System.currentTimeMillis(), HOST_3.name, "10.177.116.41", "RTPR", Document().apply {
            put("src", HOST_3.name)
            put("dst", "10.177.116.41")
       })

        val EVENT_5 = Event(System.currentTimeMillis(), HOST_1.name, "10.20.30.40", "SIP", Document().apply {
            put("type", "SIP")
            put("src", HOST_1.name)
            put("dst", "10.20.30.40")
        ...
        val EVENT_6 = Event(System.currentTimeMillis(), HOST_1.name, "10.20.30.40", "SIP", Document().apply {
            put("type", "SIP")
            put("src", HOST_1.name)
            put("dst", "10.20.30.40")
