...
class RegisterSessionServiceTest {
    ...
    fun `Validate 'details()' method`() {
        // Init
        given(client.find(any(), any(), any(), any(), any()))
                .willReturn(sequenceOf(REGISTER_1, REGISTER_2, REGISTER_3, REGISTER_4).iterator())
        ...
        // Execute
        val result = service.details(request) as? List<Document>
